...
<div class="relative overflow-x-auto">
    ...
    <div class="mt-2 flex justify-center items-center">
     <button type="button" id="pilihPemilihBtn" onclick="populateKorTps('${pemilih[0].id}', \`${pemilih[0].nama}\`, '${pemilih[0].alamatKtp.replace(/'/g, "\\'")}')" class="flex justify-items-center text-white bg-orange-600 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
        Pilih
